...
using [`stats_hero_worker_sup:new_worker/1`](http://github.com/opscode/stats_hero/blob/master/doc/stats_hero_worker_sup.md#new_worker-1) like this:<pre>    Config = [{estatsd_host, EstatsdServer},
...
test_hero.application.byRequestType.nodes.PUT:1|m</pre>When [`stats_hero:report_metrics/2`](http://github.com/opscode/stats_hero/blob/master/doc/stats_hero.md#report_metrics-2) is called the worker sends:
<pre>1|640
